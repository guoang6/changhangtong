...
<el-form ref="form" :model="form" label-width="80px" size="medium ">
  ...
  <el-form-item label="开始时间">
    <el-col :span="11">
      <el-date-picker  value-format="yyyy-MM-dd"  type="date" placeholder="选择日期" v-model="form.startdate1" style="width: 100%;"></el-date-picker>
    </el-col>
    <el-col class="line" :span="2">-</el-col>
    <el-col :span="11">
      <el-time-picker value-format="hh:mm:ss" placeholder="选择时间" v-model="form.startdate2" style="width: 100%;"></el-time-picker>
    </el-col>
  </el-form-item>

  <el-form-item label="结束时间">
    <el-col :span="11">
      <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="form.enddate1" style="width: 100%;"></el-date-picker>
    </el-col>
    <el-col class="line" :span="2">-</el-col>
    <el-col :span="11">
      <el-time-picker value-format="hh:mm:ss" placeholder="选择时间" v-model="form.enddate2" style="width: 100%;"></el-time-picker>
    </el-col>
  </el-form-item>
